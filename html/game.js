...
var manifest = {
	...
	"sounds": {
		"bump": "audio/bump.wav",
		"crumble1": "audio/crumble1.wav",
		"crumble2": "audio/crumble2.wav",
		"crumble3": "audio/crumble3.wav",
		"crumble4": "audio/crumble4.wav",
		"hamster-fall": "audio/hamster-fall.wav",
		"jump": "audio/jump.wav",
		"podium": "audio/podium.wav",
		"skull-on": "audio/skull-on.wav",
		"squeak1": "audio/squeak1.wav",
		"squeak2": "audio/squeak2.wav",
		"step1": "audio/step1.wav",
		"step2": "audio/step2.wav",
		"step3": "audio/step3.wav",
		"step4": "audio/step4.wav",
		"step5": "audio/step5.wav",
	},
	"fonts": {},
	"animations": {
...
game.scenes.add("controls", new Splat.Scene(canvas, function() {}, function() {
	if (game.keyboard.consumePressed("space") || game.keyboard.consumePressed("left") || game.keyboard.consumePressed("right") || game.mouse.consumePressed(0)) {
		game.scenes.switchTo("main");
	}
}, function(context) {
